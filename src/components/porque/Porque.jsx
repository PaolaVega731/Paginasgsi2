  ...
  return (
    <section id='por-que' className='flex flex-col justify-center '>
      ...
      <div className='relative -mx-[60px] '>
        ...
        <img
          className='w-60 h-60 absolute left-10 top-80 2xl:top-60 2xl:left-16'
          src='./vectores/Personas.png'
          alt='Tres personas dandose la mano'
        />

        <img
          className='w-60 h-60 absolute top-[700px] right-[60px] 2xl:bottom-10 2xl:right-[670px]'
        ...
        <ServiceItem
          ...
          position='bottom-[310px] left-[195px] 2xl:bottom-[160px] 2xl:left-[160px]'
        />

        <ServiceItem
          title='Ahorro de tiempo'
          description='Delega estos procesos complejos a profesionales certificados en la norma.'
          position='bottom-[360px] right-[215px] 2xl:bottom-[350px] 2xl:right-[320px]'
        />
        <ServiceItem
          ...
          position='top-[410px] left-[510px] 2xl:top-[470px] 2xl:left-[380px]'
        />
        <ServiceItem
          ...
          position='top-[240px] right-[190px] 2xl:top-[240px] 2xl:right-[210px]'
        />
        <ServiceItem
          ...
          position='top-[190px] left-[240px] 2xl:top-[65px] 2xl:left-[300px]'
        />
        <ServiceItem
          ...
          position='bottom-[60px] right-[525px] 2xl:bottom-[15px] 2xl:right-[265px]'
        />
      </div>
    </section>
  );
